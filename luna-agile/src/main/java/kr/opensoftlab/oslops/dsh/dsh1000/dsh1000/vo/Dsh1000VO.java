...
public class Dsh1000VO extends PageVO {
	...
	private String processStartMonth;
	private String processEndMonth;
	...
	public String getProcessStartMonth() {
		return processStartMonth;
	}
	public void setProcessStartMonth(String processStartMonth) {
		this.processStartMonth = processStartMonth;
	}
	public String getProcessEndMonth() {
		return processEndMonth;
	}
	public void setProcessEndMonth(String processEndMonth) {
		this.processEndMonth = processEndMonth;
	}
