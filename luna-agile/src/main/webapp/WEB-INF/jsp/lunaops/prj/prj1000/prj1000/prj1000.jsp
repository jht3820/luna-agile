...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__head kt-portlet__head--lg osl-portlet__head__block ">
		...
		<div class="col-lg-9 col-md-12 col-sm-12 text-right kt-padding-r-0">
			<button type="button" class="btn btn-outline-brand btn-bold btn-font-sm kt-margin-r-5 btn-elevate btn-elevate-air" data-datatable-id="prj1000PrjTable" data-datatable-action="select" title="데이터 조회" data-toggle="kt-tooltip" data-skin="brand" data-placement="bottom" data-auth-button="select" tabindex="1">
							...
							+'<div class="kt-portlet__foot kt-portlet__foot--sm">'
								+'<div class="row">'
									...
									+'<div class="col-lg-3 col-md-6 col-sm-12">'
										+'<div class="osl-widget kt-padding-l-15">'
											+'<div class="osl-widget-info__item">'
												+'<div class="osl-widget-info__item-icon"><img src="/media/osl/icon/reqChargers.png"></div>'
												+'<div class="osl-widget-info__item-info">'
