	...
	firstGrid = new ax5.ui.grid();
        ...
        firstGrid.setConfig({
            ...
            body: {
                ...
                columnHeight: 30,
                onDBLClick:function(){
                	var data = {"popupGb": "update", "svnRepId": firstGrid.list[this.doindex].svnRepId};
    				gfnLayerPopupOpen('/stm/stm2000/stm2000/selectStm2001RepositoryDetailView.do',data,"650","540",'scroll');	
 ...
 * SVN Repository 삭제
 */
function fnDeleteStm2000Info(svnRepId){
	//AJAX 설정
	var ajaxObj = new gfnAjaxRequestAction(
			...
			mySearch.setConfig({
				...
				rows:[
					{display:true, addClass:"", style:"", list:[
						{label:"", labelWidth:"", type:"button", width:"80",style:"float:right;", key:"btn_connect_svn",valueBoxStyle:"padding:5px;", value:"<i class='fas fa-angle-double-right' aria-hidden='true'></i>&nbsp;<span>접속확인</span>",
							onclick:function(){
								...
								fnSelectStm2000ConfirmConnect(item.svnRepId,  firstGrid.focusedColumn[Object.keys(firstGrid.focusedColumn)].doindex );
						}}                                      
					  ]
					},
					{display:true, addClass:"", style:"", list:[
						{label:"<i class='fa fa-search'></i>&nbsp;", labelWidth:"50", type:"selectBox", width:"", key:"searchSelect", addClass:"", valueBoxStyle:"", value:"all",
							options:[
                                ...
                                {optionValue:'svnRepNm', optionText:'Reposityory 명'},
                                {optionValue:'svnTxt', optionText:'Reposityory 설명'},
						...
						{label : "",labelWidth : "",type : "button",width : "55",key : "btn_delete_svn",style : "float:right;",valueBoxStyle : "padding:5px;",value : "<i class='fa fa-trash-alt' aria-hidden='true'></i>&nbsp;<span>삭제</span>",
							onclick : function() {
								...
								if(confirm("삭제 하시겠습니까?")){
									fnDeleteStm2000Info(item.svnRepId);
								}
							}
						},
						...
						{label:"", labelWidth:"", type:"button", width:"60",style:"float:right;", key:"btn_update_svn",valueBoxStyle:"padding:5px;", value:"<i class='fa fa-edit' aria-hidden='true'></i>&nbsp;<span>수정</span>",
							onclick:function(){
								...
								var data = {"popupGb": "update", "svnRepId": item.svnRepId};
 ...
 * 
 */
function fnSelectStm2000ConfirmConnect(svnRepId,index){
	//AJAX 설정

	var ajaxObj = new gfnAjaxRequestAction(
			{"url":"<c:url value='/stm/stm2000/stm2000/selectStm2000ConfirmConnect.do'/>","loadingShow":true}
			,{ "svnRepId" : svnRepId });
