        ...
        firstGrid.setConfig({
            ...
            body: {
                ...
                onDBLClick:function(){
					...
					gfnLayerPopupOpen('/svn/svn1000/svn1000/selectSvn1000RepositoryDetailView.do',data,"640","673",'scroll');
					 */
                }
            } ,
            page: {
...
function fnInGridListSet(_pageNo,ajaxParam){
		...
		var ajaxObj = new gfnAjaxRequestAction(
				{"url":"<c:url value='/stm/stm2000/stm2200/selectStm2200RepProjectListAjaxView.do'/>","loadingShow":true}
				,ajaxParam);
		//AJAX 전송 성공 함수
...
<div class="main_contents" style="height: auto;">
	<form:form commandName="stm2200VO" id="searchFrm" name="searchFrm" method="post" onsubmit="return false;">
	</form:form>
