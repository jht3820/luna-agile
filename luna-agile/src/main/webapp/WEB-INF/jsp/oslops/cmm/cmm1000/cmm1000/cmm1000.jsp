...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#btnPopCmm1000Select').click(function() {
			gfnCheckRow(popGrid);
		});
	...
	function fnInGridPopListSet(_pageNo,ajaxParam){
    	...
    	var data=gfnSelectCmm1000CommonUserList(ajaxParam);
		var list = data.list;
...
<div class="popup">
	...
	<div class="pop_sub">
		...
		<div class="btn_div">
			<div class="button_normal save_btn" id="btnPopCmm1000Select" >선택</div>
			<div class="button_normal exit_btn" id="btnPopCmm1000Cancle" >취소</div>
		</div>
	</div>
	</form>
</div>
